...
/**
 * This class is in charge of providing the methods to manage cache on the server.
 *
 * @param <K> key from object has been saved in cache
 * @param <V> object has been saved in cache
 */
